...
class Member{
	void show1(Team<Top> t) {};					// Team<Top> t 				Team 객체		Top 객체
	void show2(Team<?> t) {};					// Team<?> t 				Team 객체		아무거나 
	void show3(Team<? extends Sub> t) {};		// Team<? extends Sub> t	Team 객체		Sub, Cen, Bot 객체
	void show4(Team<? super Sub> t) {};			// Team<? super Sub> t		Team 객체		Sub, Top, Object 객체
}
